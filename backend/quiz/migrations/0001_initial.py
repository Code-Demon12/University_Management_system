    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_en', models.CharField(db_index=True, max_length=60, null=True)),
                ('title_fr', models.CharField(db_index=True, max_length=60, null=True)),
                ('title_es', models.CharField(db_index=True, max_length=60, null=True)),
                ('title_ru', models.CharField(db_index=True, max_length=60, null=True)),
